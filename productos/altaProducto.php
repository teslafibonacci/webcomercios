...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.php">Alta Productos</a>
    ...
    <div class="container mt-3">
        ...
        <form method="post" action="guardaProducto.php">
            <div class="mb-3 mt-3">
                ...
                <label for="clave" classe="form-label"><strong>Selecciona el id del producto</strong></label>
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="producto" placeholder="Nombre del producto" name="producto">
            </div>
