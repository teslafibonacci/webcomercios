...
<head>
    <title>Modifica Comercios</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.php">Modifica Comercios</a>
    ...
    <div class="container mt-3">
        ...
        <br>
        <form id="formulario" method="post" action="actualizaComercio.php">
            <div>
                ...
                <input type="text" class="form-control" id="comercio" name="comercio" value="" required>
            </div>
            <button type="submit" class="btn btn-primary mt-3">Modificar Comercio</button>
        </form>
    </div>
</body>
