...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.php">Baja Elementos</a>
    ...
    <div class="container mt-3">
        ...
        <br>
        <form id="formulario" method="post" action="borraElemento.php">
            <div>
            ...
            <button type="submit" class="btn btn-primary mt-3">Eliminar Elemento</button>
        </form>
        <br>
    </div>
</body>
